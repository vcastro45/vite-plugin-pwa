export const commands = [
  ...
  'npx tsup src/client/build/vue2composition.ts --external vue --format esm -d dist/client/build',
  ...
  'npx tsup src/client/dev/vue2composition.ts --external vue --format esm -d dist/client/dev',
